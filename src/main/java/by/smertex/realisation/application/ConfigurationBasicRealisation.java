...
import by.smertex.realisation.cfg.ProxyEntityFactoryBasicRealisation;
...
public class ConfigurationBasicRealisation implements Configuration{
    ...
    public ConfigurationBasicRealisation(){
        ...
        this.proxyEntityFactory = new ProxyEntityFactoryBasicRealisation(connectionManager, entityManager);
